  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-3">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-maroon-50 via-yellow-50 to-green-50">
        ...
        <img src="/tooth.png" alt="Tooth" className="absolute top-20 left-10 rotate-45 w-20 opacity-10" />
        <motion.div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div className="space-y-8" variants={itemVariants}>
            <div className="space-y-4">
              <motion.div className="flex items-center space-x-2 text-maroon-600" variants={itemVariants}>
                <Star className="w-5 h-5 fill-current" />
                <span className="text-sm font-medium tracking-wide">Excellence Since 2015</span>
              </motion.div>

              {/* Main H1 Title */}
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-maroon-800 leading-tight bg-gradient-to-r from-maroon-800 via-maroon-600 to-yellow-600 bg-clip-text text-transparent">
                {t('hero.title')}
              </h1>

              {/* H2 Subtitle */}
              <h2 className="text-xl text-gray-600 leading-relaxed font-medium">{t('hero.subtitle')}</h2>
            </div>
            ...
            {/* Stats */}
            <motion.div className="grid grid-cols-3 gap-6 pt-8 border-t border-gray-200" variants={itemVariants}>
              {[
        ...
        >
          {[
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <motion.div animate={{ rotate: [0, 10, -10, 0] }} transition={{ duration: 4, repeat: Infinity, delay: index * 0.5 }}>
